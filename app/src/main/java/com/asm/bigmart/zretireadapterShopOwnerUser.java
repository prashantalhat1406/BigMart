...
public class zretireadapterShopOwnerUser extends ArrayAdapter<User> {
    List<User> users;
    Context context;
    User user;


    public zretireadapterShopOwnerUser(@NonNull Context context, int resource, @NonNull List<User> objects) {
